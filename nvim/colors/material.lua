...
-- Markdown
local markdown_heading_colors = { orange, green, yellow, cyan, blue, purple }
...
if not tostring(style):match("%-community$") then
  ...
  set_hl("markdownH1", markdown_heading_colors[1], nil, nil)
  set_hl("markdownH2", markdown_heading_colors[2], nil, nil)
  set_hl("markdownH3", markdown_heading_colors[3], nil, nil)
  set_hl("markdownH4", markdown_heading_colors[4], nil, nil)
  set_hl("markdownH5", markdown_heading_colors[5], nil, nil)
  set_hl("markdownH6", markdown_heading_colors[6], nil, nil)
...
if vim.fn.has("nvim") == 1 then
  ...
  if vim.fn.has("nvim-0.8") == 1 then
    ...
    set_hl("@markup.heading.1", markdown_heading_colors[1], nil, nil)
    set_hl("@markup.heading.2", markdown_heading_colors[2], nil, nil)
    set_hl("@markup.heading.3", markdown_heading_colors[3], nil, nil)
    set_hl("@markup.heading.4", markdown_heading_colors[4], nil, nil)
    set_hl("@markup.heading.5", markdown_heading_colors[5], nil, nil)
    set_hl("@markup.heading.6", markdown_heading_colors[6], nil, nil)
    set_hl("@markup.italic", pink, nil, "italic")
    set_hl("@markup.italic.markdown_inline", pink, nil, "italic")
    ...
    set_hl("@markup.strong.markdown_inline", pink, nil, "bold")
