...
- `bun add -g package-name` - [Purpose]
- `bun add -g another-package` - [Purpose]
...
- Write Bun scripts (not Python) for complex logic
...
Remember: All scripts should be Bun with TypeScript and ESM imports, not Python!
