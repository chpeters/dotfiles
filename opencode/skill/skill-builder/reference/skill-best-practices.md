...
# Convert to JSON with Bun
bun convert-to-json.ts active.csv > users.json
```
...
### Use Bun for Scripting

**Always prefer Bun over Python.**

**Bun advantages:**
- Consistent with the Bun/TypeScript ecosystem
- Modern async/await
- Native JSON support
- Fast startup
